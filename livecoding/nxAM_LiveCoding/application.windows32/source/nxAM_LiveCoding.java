...
public class nxAM_LiveCoding extends PApplet {
...
// figure A1 - 
float A1_PositionX = random(2.0f,2.0f);
float A1_PositionY = random(2.0f,2.0f);
float A1_VelocityX = random(5.0f,5.0f);
float A1_VelocityY = random(5.0f,5.0f);
float A1_Scale = 0.0f;
int A1_Angles = PApplet.parseInt(random(2,6));
...
// figure A2 - 
float A2_PositionX = random(2.0f,2.0f);
float A2_PositionY = random(2.0f,2.0f);
float A2_VelocityX = random(5.0f,5.0f);
float A2_VelocityY = random(5.0f,5.0f);
float A2_Scale = 0.0f;
int A2_Angles = PApplet.parseInt(random(2,6));
...
// figure A3 - 
float A3_PositionX = random(2.0f,2.0f);
float A3_PositionY = random(2.0f,2.0f);
float A3_VelocityX = random(5.0f,5.0f);
float A3_VelocityY = random(5.0f,5.0f);
float A3_Scale = 0.0f;
int A3_Angles = PApplet.parseInt(random(2,6));
...
// figure A4 - 
float A4_PositionX = random(2.0f,2.0f);
float A4_PositionY = random(2.0f,2.0f);
float A4_VelocityX = random(5.0f,5.0f);
float A4_VelocityY = random(5.0f,5.0f);
float A4_Scale = 0.0f;
int A4_Angles = PApplet.parseInt(random(2,6));
...
public void nxAM( int sides, float r1, float r2, float h)
{
...
public void oscEvent(OscMessage theOscMessage) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "nxAM_LiveCoding" };
    if (passedArgs != null) {
